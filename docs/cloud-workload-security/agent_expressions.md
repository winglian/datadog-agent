...
| `mmap.flags` | int | Flags of the mmap syscall |
| `mmap.protection` | int | Protection given to the memory segment |
...
| Property | Type | Definition |
| -------- | ---- | ---------- |
| `mprotect.new_protection` | int | New memory protection of the segment |
| `mprotect.retval` | int | Return value of the syscall |
| `mprotect.vm_protection` | int | Initial memory protection of the segment |
...
| Property | Type | Definition |
| -------- | ---- | ---------- |
| `ptrace.request` | int | Request of the ptrace syscall |
