...
require (
	...
	github.com/DataDog/datadog-agent/pkg/quantile v0.34.0-rc.5
	github.com/DataDog/datadog-agent/pkg/security/secl v0.34.0-rc.5
	github.com/DataDog/datadog-agent/pkg/util/log v0.34.0-rc.5
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.34.0-rc.5
