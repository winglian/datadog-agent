...
func TestMarshalUnmarshalClientStatsPoint(t *testing.T) {
	v := ClientStatsPoint{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgClientStatsPoint(b *testing.B) {
	v := ClientStatsPoint{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgClientStatsPoint(b *testing.B) {
	v := ClientStatsPoint{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalClientStatsPoint(b *testing.B) {
	v := ClientStatsPoint{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeClientStatsPoint(t *testing.T) {
	v := ClientStatsPoint{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeClientStatsPoint Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeClientStatsPoint(b *testing.B) {
	v := ClientStatsPoint{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeClientStatsPoint(b *testing.B) {
	v := ClientStatsPoint{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
