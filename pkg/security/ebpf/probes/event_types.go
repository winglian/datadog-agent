...
func SelectorsPerEventType() map[eval.EventType][]manager.ProbesSelector {
	return map[eval.EventType][]manager.ProbesSelector{
		...
		"*": {
			...
			&manager.OneOf{
				Selectors: ExpandSyscallProbesSelector(
