...
var fileDescriptor_4fedc7af734c34ba = []byte{
	...
	0x21, 0x16, 0x2b, 0x31, 0x38, 0xf9, 0x5f, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3, 0x87,
	...
	0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x92, 0x2c,
	0xc8, 0x4e, 0xd7, 0x07, 0x07, 0xa0, 0x7e, 0x41, 0x52, 0x7a, 0x3e, 0x52, 0xe0, 0x26, 0xb1, 0x81,
	0x85, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xf1, 0x7c, 0xaa, 0x1d, 0xb5, 0x01, 0x00, 0x00,
}
...
func (this *ExportTraceServiceRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&otlp.ExportTraceServiceRequest{")
...
func (this *ExportTraceServiceResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&otlp.ExportTraceServiceResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ExportTraceServiceRequest) String() string {
	...
	for _, f := range this.ResourceSpans {
		repeatedStringForResourceSpans += strings.Replace(fmt.Sprintf("%v", f), "ResourceSpans", "ResourceSpans", 1) + ","
	}
