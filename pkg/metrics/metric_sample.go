...
func (m *MetricSample) GetTags(tb *tagset.HashingTagsAccumulator, tbEnrich *tagset.HashingTagsAccumulator) {
	tb.Append(m.Tags...)
	tagger.EnrichTags(tbEnrich, m.OriginID, m.K8sOriginID, m.Cardinality)
}
