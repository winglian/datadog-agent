...
func TestGenerateReproductible(t *testing.T) {
	...
	assert.Equal(t, ContextKey(0xaae35e9a83d8b851), firstKey)
	...
	assert.Equal(t, ContextKey(0x39f46165fea809b1), otherKey)
}
...
func TestGenerateReproductible2(t *testing.T) {
	...
	assert.Equal(t, ContextKey(0xaae35e9a83d8b851), firstKey)
	assert.Equal(t, TagsKey(0x84044bbc4154aa14), tagsKey1)
