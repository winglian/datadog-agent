...
// func BenchmarkTimeSamplerFlush(b *testing.B) {
...
// 	b.ResetTimer()
// 	for n := 0; n < b.N; n++ {
// 		samplers[n].flushSeries(100)
// 	}
// }

// Before
// BenchmarkTimeSamplerFlush-8            1         601088193 ns/op        322291480 B/op   2019016 allocs/op
